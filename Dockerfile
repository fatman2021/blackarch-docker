...
# Dem deps
RUN pacaur -S --needed --noconfirm --noedit --devel afflib aircrack-ng arch-install-scripts autoconf avr-libc bash bluez bluez-libs bluez-utils \
 ...
 qt4 qt5-base readline ruby ruby1.8 ruby1.9 ruby-activemodel=4.0.1 \
